    ...
    <div class="container">
        <div id="mainDiv" class="row">
            ...
            <div class="title pb-5 col-12">
                <h2 class="align-left mbr-fonts-style m-0 display-2">Entertainment</h2>
            </div>
...
<script>
  ...
  const getEntertainment = async () => {
    ...
    let url = "http://localhost:3002/all_entertainment";
    ...
    for (var i=0; i<myJson.length; i++) {
        ...
        a.href = "/explore/Entertainment_Description.php?id=" + myJson[i].entertainment_id;
        a.innerHTML = "&gt;";

      	var text = document.createTextNode(myJson[i].entertainment_name);
  ...
  window.onLoad = getEntertainment();
