    ...
    <div class="container">
        <div id="mainDiv" class="row">
            ...
            <div class="title pb-5 col-12">
                <h2 class="align-left mbr-fonts-style m-0 display-2">Categories</h2>
            </div>
...
var categoriesLength;
  ...
  const getCategories = async () => {
    ...
    let url = "http://localhost:3002/all_categories";
    ...
    for (var i=0; i<myJson.length; i++) {
    	...
    	var div1 = document.createElement("div");
      	...
      	a.href = "/explore/Category_Brand.php?id=" + myJson[i].category_id;
      	a.innerHTML = "&gt;";
        

      	var text = document.createTextNode(myJson[i].category_name);
