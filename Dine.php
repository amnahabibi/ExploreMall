    ...
    <div class="container">
        <div id="mainDiv" class="row">
            ...
            <div class="title pb-5 col-12">
                <h2 class="align-left mbr-fonts-style m-0 display-2">Dine-In</h2>
            </div>
...
<script>
  ...
  const getEatery = async () => {
    ...
    let url = "http://localhost:3002/all_eatery";
    ...
    for (var i=0; i<myJson.length; i++) {
    	...
    	var div1 = document.createElement("div");
         ...
         a.href = "/explore/Eatery_Description.php?id=" + myJson[i].eatery_id;
        a.innerHTML = "&gt;";

      	var text = document.createTextNode(myJson[i].eatery_name);
